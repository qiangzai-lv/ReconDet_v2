_base_ = [
    '../_base_mmdet_/datasets/coco_detection.py',
    '../_base_mmdet_/schedules/schedule_1x.py', '../_base_mmdet_/default_runtime.py'
]
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=arkit_ann_root + 'arkit_bbox_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=arkit_ann_root + 'arkit_bbox_val.json',
        data_prefix=dict(img=''),
        metainfo=metainfo,
        return_classes=True,
        test_mode=True,
